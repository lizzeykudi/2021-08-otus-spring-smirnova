...
public class ApplicationShellCommands {
    ...
    public ApplicationShellCommands(ApplicationContext context, BookDao bookDao, AuthorDao authorDao, BookGenreDao bookGenreDao, CommentDao commentDao, BookService bookService, CommentService commentService) {
