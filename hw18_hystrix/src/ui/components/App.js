...
export default class App extends React.Component {
    ...
    render() {
        return (<React.Fragment>
            {this.state.errorVisible ? <div style={{color:"red"}}>An error occurred, try again</div> : null}
            <Header title={'Books'}/>
            <table>
                <thead>
                <tr>
                            ...
                            <React.Fragment>
                                ...
                                <td>
                                    <select className="form-control" name="author" value={this.state.editBookAuthorId}
                                        ...
                                        {this.state.authors? this.state.authors.map((author, i) => (
                                            <option value={author.id}>{author.name}</option>)) : null}
                                ...
                                <td>
                                    <select className="form-control" name="bookGenre" value={this.state.editBookGenreId}
                                        ...
                                        {this.state.bookGenres? this.state.bookGenres.map((bookGenre, i) => (
                                            <option value={bookGenre.id}>{bookGenre.title}</option>)) : null}
                                        <option value={-1}></option>
                                    </select>
                                </td>
                                <td>
